...
const TetData tetrominos[7] = {
    [0] = {.size = 3, .name = SHAPE_L, .data = {false, false, true, true, true, true, false, false, false, false, false, false}}, // L
    [1] = {.size = 3, .name = SHAPE_J, .data = {true, false, false, true, true, true, false, false, false, false, false, false}}, // J
    ...
    [4] = {.size = 3, .name = SHAPE_T, .data = {false, true, false, true, true, true, false, false, false, false, false, false}}, // T
